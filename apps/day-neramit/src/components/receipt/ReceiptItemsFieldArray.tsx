...
export function ReceiptItemsFieldArray() {
  const { control, register, formState } = useFormContext<ReceiptFormValues>();
  const { fields, append, remove } = useFieldArray({ control, name: "items" });

  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-semibold text-white">รายการ (ไม่จำกัดจำนวน)</h3>
        <button
          type="button"
          onClick={() =>
            append({
          ...
          >
            <div className="col-span-12">
              <input
                ...
                placeholder="รายการ เช่น ค่าบริการล้างแอร์"
